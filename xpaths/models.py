...
class XpathList(models.Model):
	...
	relay_links = models.CharField(max_length=1000, blank=True)
	...
	product_seller = models.CharField(max_length=1000, blank=True)
	product_color = models.CharField(max_length=1000, blank=True)
	product_current_price = models.CharField(max_length=1000)
	product_old_price = models.CharField(max_length=1000, blank=True)
	product_categories = models.CharField(max_length=1000)
	product_sizes = models.CharField(max_length=1000)
	product_percentage_off = models.CharField(max_length=1000, blank=True)
	product_images = models.CharField(max_length=1000)
	product_description = models.CharField(max_length=1000)
	product_filters = models.CharField(max_length=1500, default="", blank=True)
	product_filters_texts = models.CharField(max_length=1500, default="", blank=True)
