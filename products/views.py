...
def crawl(request):
	...
	if request.method == 'POST':
		...
		result = q.enqueue(crawl_worker, website_name, major_url, relay_links, start_page_number, end_page_number, concatenation_pattern, product_url, product_name, product_seller, product_color, product_current_price, product_old_price, product_categories, product_sizes, product_percentage_off, product_images, product_description, product_filters, product_filters_texts)
